...
- Analytics and error tracking (PostHog) are optional, proxied through the app's own origin, and never see SQL, blueprint content, or user identity. Details in `docs/SECURITY_MODEL.md`.
